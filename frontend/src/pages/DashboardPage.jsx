        ...
        if (user?.email) {
          ...
          if (toolsRes.status === "success") {
            ...
            const slugMap = JSON.parse(
              localStorage.getItem("xplore_slug_map") || "{}",
            );
            toolsData.forEach((t) => {
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          <div>
            <h1
              className="h1-xl"
              style={{ color: "var(--primary)", fontSize: "40px" }}
            >
        ...
        >
          <DashboardTools allTools={allTools}/>
            ...
            >
              ...
              <div className="flex flex-col gap-lg">
                {profile?.suggestions?.length > 0 ? (
                  ...
                  >
                    Aucune activité pour le moment. Pourquoi ne pas suggérer un
                    outil ?
                  </p>
                )}
              </div>
          ...
          <div style={{ marginTop: "40px" }}>
            <div
              ...
              style={{
                ...
                borderRadius: "32px",
                background:
                  "linear-gradient(135deg, rgba(0, 219, 233, 0.05) 0%, rgba(235, 178, 255, 0.05) 100%)",
              }}
            >
              ...
              >
                Rejoignez la communauté et aidez-nous à découvrir les meilleures
                IA.
              </p>
