...
const AdminCommentsPage = () => {
  ...
  if (loading) {
    return <div className="admin-loading"><div className="loader" /><p>Chargement des commentaires...</p></div>;
  }
  ...
  return (
    <div className="admin-page">
      <section className="admin-page-head">
        <div>
          <p className="label-sm" style={{ color: 'var(--outline)' }}>Gestion commentaire</p>
          <h1 className="h2-lg" style={{ marginTop: '8px' }}>Avis et retours utilisateurs</h1>
        </div>
      ...
      <div className="admin-grid-two">
        <section className="glass-panel admin-panel">
          <div className="admin-section-head">
            <div>
              <p className="label-sm" style={{ color: 'var(--outline)' }}>Sélection</p>
              <h2 className="h3-md" style={{ marginTop: '8px' }}>{toolDetails?.name || 'Aucun outil sélectionné'}</h2>
            </div>
            <span className="admin-pill">{reviews.length} avis</span>
          </div>

          <div className="admin-comment-summary">
            <p style={{ color: 'var(--on-surface-variant)' }}>{toolDetails?.description || 'Sélectionnez un outil pour afficher ses commentaires publics.'}</p>
          </div>
        </section>
        ...
        <section className="glass-panel admin-panel">
          <div className="admin-section-head">
            <div>
              <p className="label-sm" style={{ color: 'var(--outline)' }}>Commentaires</p>
              <h2 className="h3-md" style={{ marginTop: '8px' }}>Derniers avis</h2>
            </div>
          </div>
